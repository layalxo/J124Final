...
**Step-by-step answer:**
1. Sort the column "Percent change from Starting to Mid-Career Salary" in the "degrees-that-pay-back" data sheet from Z->A to find the highest percent change from starting to mid-career (median) salary, like so: <br>
...
2. Sort the column "Percent change from Starting to Mid-Career Salary" in the "degrees-that-pay-back" data sheet from A->Z to find the lowest percent change of starting to mid-career (median) salary, like so: <br>
...
3. On the first empty box in that column, type in the formula: "=(H2-E2)/E2."
4. On that box, click on the "%" symbol to turn the value into a percent.
5. Double click the bottom right corner of box I2 so the rest of the boxes in column I get a percent too.
6. The data set should appear as so:
